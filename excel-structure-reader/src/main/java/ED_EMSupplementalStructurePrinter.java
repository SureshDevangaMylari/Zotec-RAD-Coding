...
/**
 * Loads ED_EM Supplemental Tool.xlsx via Apache POI and prints the first 20 rows
 * of each sheet (COPA, DATA, RISK) with column headers for structure analysis.
 * <p>
 * Run from excel-structure-reader: mvn compile exec:java
 */
public class ED_EMSupplementalStructurePrinter {
    ...
    public static void main(String[] args) {
        ...
        if (!resolved.toFile().exists()) {
            resolved = Path.of(System.getProperty("user.dir"), "..", "resources", "ED_EM Supplemental Tool.xlsx");
        }
